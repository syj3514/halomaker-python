...
!=======================================================================
   ...
   integer(kind=4) :: igroup, igr, igroup_now, color_id
...
!#####################################################################
   ...
   if(allocated(refmask)) deallocate(refmask)
   if(allocated(mass_cell)) deallocate(mass_cell)
   if(allocated(size_cell)) deallocate(size_cell)
   if(allocated(pos_cell)) deallocate(pos_cell)
   if(allocated(sister)) deallocate(sister)
   if(allocated(firstchild)) deallocate(firstchild)
   if(allocated(idpart)) deallocate(idpart)
   if(allocated(idpart_tmp)) deallocate(idpart_tmp)
   if(allocated(idpart_adapt)) deallocate(idpart_adapt)
   if(allocated(distance)) deallocate(distance)
   if(allocated(firstpart)) deallocate(firstpart)
   if(allocated(idgroup)) deallocate(idgroup)
   if(allocated(idgroup_tmp)) deallocate(idgroup_tmp)
   if(allocated(igroupid)) deallocate(igroupid)
   if(allocated(color)) deallocate(color)
   if(allocated(densityg)) deallocate(densityg)
   if(allocated(dev_group_nhnei)) deallocate(dev_group_nhnei)
   if(allocated(dev_group_offset)) deallocate(dev_group_offset)
   if(allocated(dev_isad_all)) deallocate(dev_isad_all)
   if(allocated(dev_rho_saddle_all)) deallocate(dev_rho_saddle_all)
   if(allocated(node)) deallocate(node)
   if(allocated(first_daughter)) deallocate(first_daughter)
   if(allocated(mother)) deallocate(mother)
   if(allocated(first_sister)) deallocate(first_sister)
   if(allocated(level)) deallocate(level)
   if(allocated(icidpart_tmp)) deallocate(icidpart_tmp)
   if(allocated(queue_color)) deallocate(queue_color)
