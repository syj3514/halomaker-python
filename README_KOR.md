...
으로 분기해야 합니다. 전체 필드 단위표는 **`docs/CATALOG_FORMAT.md`** 참고.
...
row 정렬되어 `id`로 join되며, 두 출력의 전체 필드 목록은 **`docs/CATALOG_FORMAT.md`** 참고.
...
> 금속, 화학 — `docs/WHATS_NEW.md` 참고). `r200/r500`은 threshold-crossing 보간을
